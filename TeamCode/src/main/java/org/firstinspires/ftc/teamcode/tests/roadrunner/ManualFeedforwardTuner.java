...
public class ManualFeedforwardTuner extends LinearOpModeWithCommands {
    ...
    public void init_subsystems() {
        ...
        drive.setOdometryPosition(DriveTrainSubsystem.OdometryPosition.Down);
    ...
    private static MotionProfile generateProfile(boolean movingForward) {
        ...
        return MotionProfileGenerator.generateSimpleMotionProfile(start, goal, MaxVelocity, MaxAccel);
    }
